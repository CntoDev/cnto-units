...
if (diag_frameNo > cnto_last_deprecated_warn) then {
    ...
    [
        "You are using deprecated CNTO units. These will be removed some time in the future, breaking this mission.<br/>Please use the official Compositions instead, link with more info has been copied to your clipboard, Ctrl+V it into web browser.",
        1,
        20
