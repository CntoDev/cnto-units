...
/* obsolete, keep it around for old missions / compositions */
...
NAMED_SOLDIER(SOLDIER_CLASS(sq_sl),a,    INF_STR(GROUP_SQ1_NAME, Squad Leader),           SQUOTE(GROUP_SQ1_NAME), 'MAIN');
NAMED_SOLDIER(SOLDIER_CLASS(sq_medic),a, INF_STR(GROUP_SQ1_NAME, Squad Medic),            SQUOTE(GROUP_SQ1_NAME), 'MAIN');
NAMED_SOLDIER(SOLDIER_CLASS(ft_tl),a1,   INF_STR(GROUP_SQ1_NAME, 1 Fireteam Leader),      SQUOTE(GROUP_SQ1_NAME), 'BLUE');
NAMED_SOLDIER(SOLDIER_CLASS(ft_ar),a1,   INF_STR(GROUP_SQ1_NAME, 1 Autorifleman),         SQUOTE(GROUP_SQ1_NAME), 'BLUE');
NAMED_SOLDIER(SOLDIER_CLASS(ft_aar),a1,  INF_STR(GROUP_SQ1_NAME, 1 Assist. autorifleman), SQUOTE(GROUP_SQ1_NAME), 'BLUE');
NAMED_SOLDIER(SOLDIER_CLASS(ft_at),a1,   INF_STR(GROUP_SQ1_NAME, 1 Rifleman AT),          SQUOTE(GROUP_SQ1_NAME), 'BLUE');
NAMED_SOLDIER(SOLDIER_CLASS(ft_tl),a2,   INF_STR(GROUP_SQ1_NAME, 2 Fireteam Leader),      SQUOTE(GROUP_SQ1_NAME), 'YELLOW');
NAMED_SOLDIER(SOLDIER_CLASS(ft_ar),a2,   INF_STR(GROUP_SQ1_NAME, 2 Autorifleman),         SQUOTE(GROUP_SQ1_NAME), 'YELLOW');
NAMED_SOLDIER(SOLDIER_CLASS(ft_aar),a2,  INF_STR(GROUP_SQ1_NAME, 2 Assist. autorifleman), SQUOTE(GROUP_SQ1_NAME), 'YELLOW');
NAMED_SOLDIER(SOLDIER_CLASS(ft_at),a2,   INF_STR(GROUP_SQ1_NAME, 2 Rifleman AT),          SQUOTE(GROUP_SQ1_NAME), 'YELLOW');

NAMED_SOLDIER(SOLDIER_CLASS(sq_sl),b,    INF_STR(GROUP_SQ2_NAME, Squad Leader),           SQUOTE(GROUP_SQ2_NAME), 'MAIN');
NAMED_SOLDIER(SOLDIER_CLASS(sq_medic),b, INF_STR(GROUP_SQ2_NAME, Squad Medic),            SQUOTE(GROUP_SQ2_NAME), 'MAIN');
NAMED_SOLDIER(SOLDIER_CLASS(ft_tl),b1,   INF_STR(GROUP_SQ2_NAME, 1 Fireteam Leader),      SQUOTE(GROUP_SQ2_NAME), 'GREEN');
NAMED_SOLDIER(SOLDIER_CLASS(ft_ar),b1,   INF_STR(GROUP_SQ2_NAME, 1 Autorifleman),         SQUOTE(GROUP_SQ2_NAME), 'GREEN');
NAMED_SOLDIER(SOLDIER_CLASS(ft_aar),b1,  INF_STR(GROUP_SQ2_NAME, 1 Assist. autorifleman), SQUOTE(GROUP_SQ2_NAME), 'GREEN');
NAMED_SOLDIER(SOLDIER_CLASS(ft_at),b1,   INF_STR(GROUP_SQ2_NAME, 1 Rifleman AT),          SQUOTE(GROUP_SQ2_NAME), 'GREEN');
NAMED_SOLDIER(SOLDIER_CLASS(ft_tl),b2,   INF_STR(GROUP_SQ2_NAME, 2 Fireteam Leader),      SQUOTE(GROUP_SQ2_NAME), 'RED');
NAMED_SOLDIER(SOLDIER_CLASS(ft_ar),b2,   INF_STR(GROUP_SQ2_NAME, 2 Autorifleman),         SQUOTE(GROUP_SQ2_NAME), 'RED');
NAMED_SOLDIER(SOLDIER_CLASS(ft_aar),b2,  INF_STR(GROUP_SQ2_NAME, 2 Assist. autorifleman), SQUOTE(GROUP_SQ2_NAME), 'RED');
NAMED_SOLDIER(SOLDIER_CLASS(ft_at),b2,   INF_STR(GROUP_SQ2_NAME, 2 Rifleman AT),          SQUOTE(GROUP_SQ2_NAME), 'RED');

NAMED_SOLDIER(SOLDIER_CLASS(sq_sl),c,    INF_STR(GROUP_SQ3_NAME, Squad Leader),           SQUOTE(GROUP_SQ3_NAME), 'MAIN');
NAMED_SOLDIER(SOLDIER_CLASS(sq_medic),c, INF_STR(GROUP_SQ3_NAME, Squad Medic),            SQUOTE(GROUP_SQ3_NAME), 'MAIN');
NAMED_SOLDIER(SOLDIER_CLASS(ft_tl),c1,   INF_STR(GROUP_SQ3_NAME, 1 Fireteam Leader),      SQUOTE(GROUP_SQ3_NAME), 'BLUE');
NAMED_SOLDIER(SOLDIER_CLASS(ft_ar),c1,   INF_STR(GROUP_SQ3_NAME, 1 Autorifleman),         SQUOTE(GROUP_SQ3_NAME), 'BLUE');
NAMED_SOLDIER(SOLDIER_CLASS(ft_aar),c1,  INF_STR(GROUP_SQ3_NAME, 1 Assist. autorifleman), SQUOTE(GROUP_SQ3_NAME), 'BLUE');
NAMED_SOLDIER(SOLDIER_CLASS(ft_at),c1,   INF_STR(GROUP_SQ3_NAME, 1 Rifleman AT),          SQUOTE(GROUP_SQ3_NAME), 'BLUE');
NAMED_SOLDIER(SOLDIER_CLASS(ft_tl),c2,   INF_STR(GROUP_SQ3_NAME, 2 Fireteam Leader),      SQUOTE(GROUP_SQ3_NAME), 'YELLOW');
NAMED_SOLDIER(SOLDIER_CLASS(ft_ar),c2,   INF_STR(GROUP_SQ3_NAME, 2 Autorifleman),         SQUOTE(GROUP_SQ3_NAME), 'YELLOW');
NAMED_SOLDIER(SOLDIER_CLASS(ft_aar),c2,  INF_STR(GROUP_SQ3_NAME, 2 Assist. autorifleman), SQUOTE(GROUP_SQ3_NAME), 'YELLOW');
NAMED_SOLDIER(SOLDIER_CLASS(ft_at),c2,   INF_STR(GROUP_SQ3_NAME, 2 Rifleman AT),          SQUOTE(GROUP_SQ3_NAME), 'YELLOW');
